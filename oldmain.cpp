...
int main() {
    ...
    // Use the selected L-system
    axiom = axiom13;
    rules = rules13;
    iterations = iterations13 + 1;
    angle = angle13;
    ...
    float initialThickness = 6.0f; // Initial thickness of the base tree
    ...
    while (window.isOpen()) {
        ...
        drawLSystem(window, result, angle, 3.0f, offset, initialThickness);
    }
